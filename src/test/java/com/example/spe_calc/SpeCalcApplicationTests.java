...
class SpeCalcApplicationTests {
    ...
    public void testNaturalLog() {
        ...
        @Test
        public void testNaturalLogOfNegativeNumber() {
            Assertions.assertThrows(IllegalArgumentException.class, () -> {
                SpeCalcApplication.naturalLog(-1); // Natural logarithm of a negative number should throw an exception
            });
        }
        ...
        public void testSquareRootOfNegativeNumber() {
            Assertions.assertThrows(IllegalArgumentException.class, () -> {
                SpeCalcApplication.squareRoot(-25); // Square root of a negative number should throw an exception
            });
        }
        ...
        public void testFactorialOfNegativeNumber() {
            Assertions.assertThrows(IllegalArgumentException.class, () -> {
                SpeCalcApplication.factorial(-5); // Factorial of a negative number should throw an exception
            });
        }
